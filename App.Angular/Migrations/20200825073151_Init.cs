        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Product = table.Column<string>(maxLength: 64, nullable: false),
                    FunctionName = table.Column<string>(maxLength: 64, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductSector = table.Column<int>(maxLength: 15, nullable: true),
                    ProductProvider = table.Column<int>(maxLength: 15, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VendorCode = table.Column<string>(maxLength: 15, nullable: false),
                    ProductCode = table.Column<string>(maxLength: 15, nullable: false),
                    RowVersion = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorProducts", x => new { x.VendorCode, x.ProductCode });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartnerType = table.Column<int>(maxLength: 15, nullable: true),
                    Domain = table.Column<int>(maxLength: 15, nullable: false),

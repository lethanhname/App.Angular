...
namespace App.Angular.Migrations
{
    ...
    [Migration("20201231042114_workflow")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Core.Workflow.Contract.Items.WorkflowHistory", b =>
                {
            ...
            modelBuilder.Entity("App.Core.Workflow.Contract.Items.WorkflowItem", b =>
                {
                    b.Property<int>("IdentityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("WorkflowName", "EntityId")
                        .IsUnique();

                    b.ToTable("Workflow");
                });

            modelBuilder.Entity("App.Core.Workflow.Contract.Items.WorkflowVariable", b =>
                {
                    b.Property<int>("IdentityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("App.Core.Workflow.Contract.Scheduler.WorkItem", b =>
                {
                    b.Property<int>("IdentityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("App.Core.Workflow.Contract.Items.WorkflowHistory", b =>
                {
                    b.HasOne("App.Core.Workflow.Contract.Items.WorkflowItem", "Workflow")
